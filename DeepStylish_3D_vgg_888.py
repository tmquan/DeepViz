...
class Model(ModelDesc):
	...
	def vol3d_encoder(self, x, name='Vol3D_Encoder'):
		...
		# 		x = (LinearWrap(x)
		# 			.Conv2D('conv1', 3, padding='SAME')
		# 			.tf_batch_to_space('bs1')
		# 			.Conv2D('conv2', 3, padding='SAME')
		# 			.tf_batch_to_space('bs2')
		# 			.Conv2D('conv3', 3, padding='SAME')
		# 			.tf_batch_to_space('bs3')
		# 			.Conv2D('conv4', 3, padding='SAME')
		# 			.tf_batch_to_space('bs4')
		# 			())
		# 		return x
	...
	def _build_graph(self, inputs):
		...
		with tf.name_scope('visualization'):
			...
			viz = tf.concat([tf.concat([viz_vol_1, viz_vol_2, viz_vol_3, viz_vol_8, viz_img_4], 2), 
							 ...
							 tf.concat([viz_img_1, viz_img_2, viz_img_3, viz_img_5, viz_img_4], 2), 
							 ], 1)
...
class RenderingRunner(Callback):
	...
	def _trigger(self):
		...
		resultDir = 'result_stylish_3d_vgg_888/'
